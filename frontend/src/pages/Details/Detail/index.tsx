...
const Detail = ({details}:PropDetail) =>{
 ...
 return(
    <DetailContainer>
        ...
        <div><span>Financiável</span><div className="detail-value-wrapper"><span className="goal-value">{details.financeable}</span></div></div>
        <div><span>Permuta</span><div className="detail-value-wrapper"><span className="goal-value">{details.permuta}</span></div></div>
        ...
        <div><span>Suites</span> <div className="detail-value-wrapper"><span className="type-value">{details.suites}</span></div></div>
