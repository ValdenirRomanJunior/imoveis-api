...
// Launch Pages Banner
export const LaunchPagesBannerWrapper = styled.section`
  padding: 4rem 1rem;
...
export const LaunchPagesBanner = styled.div`
  max-width: 1200px;
  width: 100%;
...
export const LPHeaderContainer = styled.div`
  display: flex;
  justify-content: space-between;
  align-items: flex-start;
  gap: 2rem;
...
export const LPHeaderLeft = styled.div`
  display: flex;
  flex-direction: column;
  gap: 1rem;
  max-width: 700px;
...
export const LPBadge = styled.div`
  display: flex;
  align-items: center;
  gap: 0.5rem;
  color: #86efac;
...
export const LPHeaderRight = styled.div`
  display: flex;
  flex-direction: column;
...
export const LPPriceLabel = styled.span`
  color: #6b7280;
  font-size: 0.875rem;
`;

export const LPPriceValue = styled.div`
  color: #d9f99d;
  font-size: 3rem;
  font-weight: 400;
  line-height: 1;
...
export const LPPriceSub = styled.span`
  color: #6b7280;
  font-size: 0.875rem;
  margin-bottom: 1.5rem;
`;

export const LPCTAButton = styled.button`
...
export const LPCardsGrid = styled.div`
  display: grid;
...
export const LPCard = styled.div<{ $accentColor: string }>`
  ...
  &::after {
    ...
    right: 0;
    height: 100px;
    background: linear-gradient(180deg, ${props => props.$accentColor}1A 0%, rgba(21, 24, 28, 0) 100%);
    pointer-events: none;
  }
`;

export const LPCardHeader = styled.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  margin-bottom: 1.5rem;
...
export const LPCardTitle = styled.div<{ $accentColor: string }>`
  display: flex;
  align-items: center;
  gap: 0.5rem;
  font-size: 1.1rem;
...
export const LPCardNumber = styled.span`
  font-size: 1rem;
...
export const LPListItem = styled.li<{ $accentColor: string }>`
  display: flex;
  align-items: center;
  gap: 0.75rem;
  color: #9ca3af;
...
export const LPFooterLabel = styled.span`
  color: #6b7280;
  font-size: 0.95rem;
  white-space: nowrap;
  padding-top: 0.5rem;
...
export const LPTagsContainer = styled.div`
  display: flex;
  flex-wrap: wrap;
  gap: 1rem;
`;

export const LPTag = styled.div`
  display: flex;
  align-items: center;
  gap: 0.5rem;
  padding: 0.5rem 1rem;
