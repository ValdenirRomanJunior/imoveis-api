...
public class TenantInsertValidator implements ConstraintValidator<TenantInsert, TenantNewDTO> {

    @Autowired
    private TenantRepository tenantRepository;

    @Override
    public void initialize(TenantInsert ann) {
    }
    @Override
    public boolean isValid(TenantNewDTO objDto, ConstraintValidatorContext context) {
